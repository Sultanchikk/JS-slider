var ImageSlider = /** @class */ (function () {
    ...
    ImageSlider.prototype.showCurrentSlide = function () {
        this.slidesContainer.style.transform = "translateX(-".concat(this.currentIndex * 100, "%)");
    };
    ImageSlider.prototype.startSlideTimer = function () {
        var _this = this;
    ...
    ImageSlider.prototype.createSlide = function (color, text) {
...
var imageSlider = new ImageSlider(sliderElement);
